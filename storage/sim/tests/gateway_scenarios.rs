// Scenario tests routed through GatewayDriver, backed by FihStorage<SimIo>.
//
...
fn scenario_contradiction_detection_via_gateway() {
    ...
    let gw = GatewayDriver::new(storage);
    ...
    println!("  v GatewayDriver: Contradiction Detection -- 3 agents, JSON round-trip verified");
}
