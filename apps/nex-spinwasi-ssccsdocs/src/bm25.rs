...
// BM25 implementation body shared by both platform variants.
// The only difference is the async_trait(?Send) attribute.
macro_rules! impl_semantic_store_for_inmemory_bm25 {
    ($attr:meta) => {
        #[$attr]
...
impl_semantic_store_for_inmemory_bm25!(async_trait::async_trait);

#[cfg(all(target_arch = "wasm32", target_os = "unknown"))]
impl_semantic_store_for_inmemory_bm25!(async_trait::async_trait(?Send));
