...
pub fn create_blackboard() -> impl Blackboard + CypherCapable + EvictCapable + GraphRead + Snapshottable + StorageRead {
...
) -> impl Blackboard + CypherCapable + EvictCapable + GraphRead + Snapshottable + StorageRead {
