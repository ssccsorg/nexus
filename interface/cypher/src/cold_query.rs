...
//
// The canonical definition lives in `ext/storage-duckdb/src/cold_query.rs`.
// This module re-exports for convenience of the interface layer.

// Re-export from ext/storage-duckdb if available, or define locally.
// For now, the struct is in `ext/storage-duckdb::cold_query::ColdQuery`
