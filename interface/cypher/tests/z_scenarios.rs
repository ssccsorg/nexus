...
fn scenario_peer_review() {
    ...
    let hypothesis = Intent {
        id: CoordId::resolve("i_hypothesis"),
...
fn scenario_knowledge_synthesis() {
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_validate_synthesis"),
        from_facts: vec![CoordId::resolve("f_synthesis")],
        description:
...
fn scenario_emergency_response() {
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_respond_fire"),
        from_facts: vec![
            CoordId::resolve("f_alarm_smoke"),
            CoordId::resolve("f_alarm_temp"),
            CoordId::resolve("f_alarm_power"),
        ],
...
fn scenario_bug_fix_pipeline() {
    ...
    bb.submit_hint(&Hint {
        id: CoordId::resolve("h_severity"),
        content: "severity=P0, component=payment-api, regression=true".into(),
        creator: "triager".into(),
    })
    .unwrap();
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_triage"),
        from_facts: vec![CoordId::resolve("f_bug_1337")],
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_fix_1337"),
        from_facts: vec![CoordId::resolve("f_bug_1337"), analysis.id],
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_review_1337"),
        from_facts: vec![CoordId::resolve("f_bug_1337")],
    ...
    assert!(
        state
            .intents
            .iter()
            .any(|i| i.id == CoordId::resolve("i_fix_1337")),
        "fix intent present"
    );
...
fn scenario_ci_failure_investigation() {
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_root_cause"),
        from_facts: vec![CoordId::resolve("f_compile"), CoordId::resolve("f_tests"), CoordId::resolve("f_deps")],
...
fn scenario_supply_chain_incident() {
    ...
    bb.submit_fact(&Fact::with_id(
        CoordId::resolve("f_advisory_GHSA"),
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_assess"),
        from_facts: vec![CoordId::resolve("f_advisory_GHSA")],
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_mitigate"),
        from_facts: vec![CoordId::resolve("f_advisory_GHSA"), impact.id],
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_comms"),
        from_facts: vec![CoordId::resolve("f_advisory_GHSA"), impact.id, patch.id],
    ...
    bb.submit_hint(&Hint {
        id: CoordId::resolve("h_postmortem"),
...
fn scenario_ssccs_primitive_discovery() {
    ...
    bb.submit_fact(&Fact::with_id(
        CoordId::resolve("f_memory_pattern"),
        "llvm-ir".into(),
    ...
    bb.submit_fact(&Fact::with_id(
        CoordId::resolve("f_dataflow_pattern"),
        "mlir".into(),
    ...
    bb.submit_hint(&Hint {
        id: CoordId::resolve("h_convergence_1"),
    ...
    bb.submit_hint(&Hint {
        id: CoordId::resolve("h_convergence_2"),
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_formalize_segment"),
        from_facts: vec![
            CoordId::resolve("f_memory_pattern"),
            CoordId::resolve("f_dataflow_pattern"),
            CoordId::resolve("f_cfg_pattern"),
...
that the von Neumann architecture can be redesigned around.",
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_validate_segment"),
        from_facts: vec![CoordId::resolve("f_memory_pattern"), segment_def.id],
    ...
    bb.submit_intent(&Intent {
        id: CoordId::resolve("i_scheme_definition"),
